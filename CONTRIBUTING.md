...
- **Workflow Security**: workflow `uses:` refs and action pins use commit SHAs, not mutable tags (see CVE-2025-30066); no duplicated workflow YAML in Markdown (stale SHA pins)
